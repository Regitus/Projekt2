...
public class BildSender extends Sender
{
    ...
    protected boolean sendenZuServer(String empfaenger, String daten) throws IOException, IllegalArgumentException
    {
        ...
        {
            System.out.println("Aus Sicherheitsgründen darf die Datei nicht geüffnet werden.");
        }
        catch (IOException ex)
        {
            System.out.println("Ein Fehler ist wührend des Auslesens der Datei aufgetreten.");
        }
